  ...
  const dataSourceMateriaisTable1 = [
    {
      ...
      codigo40: '30000806',
      por41: '34.400%',
      descricao42: '340-81:TAP WATER: PIPELINE',
      quantidadePedida43: '50 Kg',
      quantidadeReal44: '-',
      adicoesMotivo45: '-',
    },
    {
      ...
      codigo40: '30226125',
      por41: '1.800%',
      descricao42: '531-0130:CERIDUST 3715:BAG2',
      quantidadePedida43: '2,6 Kg',
      quantidadeReal44: '-',
      adicoesMotivo45: '-',
    },
    {
      ...
      codigo40: '30537820',
      por41: '3.800%',
      descricao42: '425-0401:MONOETANOLAMINA',
      quantidadePedida43: '5,5 Kg',
      quantidadeReal44: '-',
      adicoesMotivo45: '-',
    },
    {
      key: '3',
      codigo40: 'Total',
      por41: [<Content26Row4Column11 />],
      descricao42: [<Content27Row4Column21 />],
      quantidadePedida43: '58,1 Kg',
      quantidadeReal44: '0 Kg',
      adicoesMotivo45: [<Content28Row4Column51 />],
    },
  ];
            ...
            <MateriaisTable1 dataSource={dataSourceMateriaisTable1}>
              <ColumnMateriaisTable1
                ...
                onFilter={(value, record: any) =>
                  record.codigo40.indexOf(value) === 0
                }
              />
              <ColumnMateriaisTable1
                title="Por (%)"
              ...
              <ColumnMateriaisTable1
                ...
                dataIndex="quantidadePedida43"
                key="quantidadePedida43"
                align="left"
                filters={[
                ...
                width="171px"
                onFilter={(value, record: any) =>
                  record.quantidadePedida43.indexOf(value) === 0
                }
              />
              <ColumnMateriaisTable1
                title="Quantidade Real"
                dataIndex="quantidadeReal44"
                key="quantidadeReal44"
                align="left"
                filters={[
                  { text: '-', value: '-' },
                ...
                width="155px"
                onFilter={(value, record: any) =>
                  record.quantidadeReal44.indexOf(value) === 0
                }
              />
              <ColumnMateriaisTable1
                title="Adições / Motivo"
                dataIndex="adicoesMotivo45"
                key="adicoesMotivo45"
                align="left"
                width="531.5px"
              />
