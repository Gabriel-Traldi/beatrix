...
const AnaliseeAprovacaodeAmostraPage = () => {
  const dataSourceFrameComponentanaliseeaprovac1 = [
    {
      ...
      title1061: '10146193',
      title1072: '179719 - João da Silva',
      title1083: '91330712 242259A: PRETO 2 FR 395665:FK22',
      title1094: 'Tinta',
      title1105: 'Make & Pack',
      status116: [
        <TagStatus11Row1Column61>
          <Warning3>Análise requerida</Warning3>
        </TagStatus11Row1Column61>,
      ],
    },
    {
      ...
      title1061: '10146194',
      title1072: '773720 - Mario Barbosa',
      title1083: '91330712 242259A: PRETO 2 FR 395665:FK22',
      title1094: 'Tinta',
      title1105: 'Make & Pack',
      status116: [
        <TagStatus12Row2Column61>
          <Error4>Enviado para Retoque</Error4>
        </TagStatus12Row2Column61>,
      ],
    },
    {
      ...
      title1061: '10146195',
      title1072: '379721 - John Carlos',
      title1083: '91330712 242259A: PRETO 2 FR 395665:FK22',
      title1094: 'Verniz',
      title1105: 'Make & Pack',
      status116: [
        <TagStatus13Row3Column61>
          <Success3>Aprovado</Success3>
        </TagStatus13Row3Column61>,
      ],
    },
  ];
  ...
  return (
    <FrameComponentanaliseeaprovac>
      ...
      <Body9>
        <FrameComponentanaliseeaprovac1
          dataSource={dataSourceFrameComponentanaliseeaprovac1}
        >
          <ColumnFrameComponentanaliseeaprovac1
            title=""
            dataIndex="checkbox20"
            key="checkbox20"
            align="center"
            width="48px"
          />
          <ColumnFrameComponentanaliseeaprovac1
            ...
            align="left"
            filters={[
              { text: '10146193', value: '10146193' },
              { text: '10146194', value: '10146194' },
              { text: '10146195', value: '10146195' },
            ]}
            width="95px"
            onFilter={(value, record: any) =>
              record.title1061.indexOf(value) === 0
            }
          />
          <ColumnFrameComponentanaliseeaprovac1
            title="Cliente"
            ...
            width="541px"
            onFilter={(value, record: any) =>
              record.title1072.indexOf(value) === 0
            }
          />
          <ColumnFrameComponentanaliseeaprovac1
            title="Produto"
            ...
            width="541px"
            onFilter={(value, record: any) =>
              record.title1083.indexOf(value) === 0
            }
          />
          <ColumnFrameComponentanaliseeaprovac1
            title="Categoria"
            ...
            width="113px"
            onFilter={(value, record: any) =>
              record.title1094.indexOf(value) === 0
            }
          />
          <ColumnFrameComponentanaliseeaprovac1
            title="Tipo"
            ...
            width="113px"
            onFilter={(value, record: any) =>
              record.title1105.indexOf(value) === 0
            }
          />
          <ColumnFrameComponentanaliseeaprovac1
            title="Status"
