...
const navigateToAlterarMateriaisModal = () => {navigate('/landing-page/alterar-materiais-modal')};
const navigateToAlertaMateriaisModal = () => {navigate('/landing-page/alerta-materiais-modal')};
  ...
  <PageHeader2    >
    <Header4    >
      ...
      <Buttons2    >
        ...
        <ButtonApproval4  onClick={navigateToAlertaMateriaisModal}
          type='default'
          icon={<CheckOutlined/>}
  ...
  <Body4    >
    ...
    <Card02    >
      <Header5    >
        ...
        <Buttons3    >
          <ButtonEdit  onClick={navigateToAlterarMateriaisModal}
            type='default'
            icon={<EditOutlined/>}
...
<ColumnMateriaisTable title='Código' dataIndex='codigo30' key='codigo30' align='left'filters={[{text: '30000806', value: '30000806'},{text: '30226125', value: '30226125'},{text: '30537820', value: '30537820'},{text: 'Total', value: 'Total'},]}width='97px'onFilter={(value, record: any) => record.codigo30.indexOf(value) === 0 } /> 
<ColumnMateriaisTable title='Por (%)' dataIndex='por31' key='por31' align='left'width='98px' /> 
<ColumnMateriaisTable title='Descrição' dataIndex='descricao32' key='descricao32' align='left'width='531.5px' /> 
<ColumnMateriaisTable title='Quantidade Pedida' dataIndex='quantidadePedida33' key='quantidadePedida33' align='left'filters={[{text: '50 Kg', value: '50 Kg'},{text: '2,6 Kg', value: '2,6 Kg'},{text: '5,5 Kg', value: '5,5 Kg'},{text: '58,1 Kg', value: '58,1 Kg'},]}width='171px'onFilter={(value, record: any) => record.quantidadePedida33.indexOf(value) === 0 } /> 
<ColumnMateriaisTable title='Quantidade Real' dataIndex='quantidadeReal34' key='quantidadeReal34' align='left'filters={[{text: '-', value: '-'},{text: '0 Kg', value: '0 Kg'},]}width='155px'onFilter={(value, record: any) => record.quantidadeReal34.indexOf(value) === 0 } /> 
<ColumnMateriaisTable title='Adições / Motivo' dataIndex='adicoesMotivo35' key='adicoesMotivo35' align='left'width='531.5px' /> 
        </MateriaisTable>
      </Body6>
    </Card02>
    <Card021    >
    ...
    <ActionsRow    >
      ...
      <ButtonApproval5  onClick={navigateToAlertaMateriaisModal}
        type='default'
        icon={<CheckOutlined/>}
        onClick = {navigateToAlertaMateriaisModal}>
          Aprovar OP
