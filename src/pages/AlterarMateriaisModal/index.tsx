...
<ColumnAlterarMateriaisTable title='Código' dataIndex='title1560' key='title1560' align='left'width='95px' /> 
<ColumnAlterarMateriaisTable title='Por (%)' dataIndex='title1571' key='title1571' align='left'width='86px' /> 
<ColumnAlterarMateriaisTable title='Descrição' dataIndex='title1582' key='title1582' align='left'width='290.5px' /> 
<ColumnAlterarMateriaisTable title='Quantidade (Kg)' dataIndex='quantidadeKg23' key='quantidadeKg23' align='left'width='134px' /> 
<ColumnAlterarMateriaisTable title='Adições/Motivo' dataIndex='title1594' key='title1594' align='left'width='290.5px' /> 
<ColumnAlterarMateriaisTable title='Ação' dataIndex='title5' key='title5' align='center'width='56px' /> 
    </AlterarMateriaisTable>
    <InputFormItem25
