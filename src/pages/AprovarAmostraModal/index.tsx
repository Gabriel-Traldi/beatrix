...
const AprovarAmostraModalPage = () => {
  return (
    <AprovarAmostraModal>
      <Header21>
        <Title178>
          <AprovarAmostra>Aprovar Amostra</AprovarAmostra>
        </Title178>
        <ButtonClose1 type="text" icon={<CloseOutlined />} />
      </Header21>
      <Body35>
        <InputFormItem6
          ...
          name="inserirLaudo"
        >
          <InputBasic6 placeholder="The plugin cannot get any placeholder" />
        </InputFormItem6>
      </Body35>
      <Footer3>
        <ButtonBack1 type="default">Voltar</ButtonBack1>
        <ButtonApply type="primary">Aplicar</ButtonApply>
      </Footer3>
    </AprovarAmostraModal>
  );
};
